...
import (
	...
	"github.com/wangzhe1991/protoc-gen-go-errorx/gerr"
	"google.golang.org/protobuf/compiler/protogen"
	"google.golang.org/protobuf/proto"
)

const (
	errorsPackage = protogen.GoImportPath("github.com/wangzhe1991/protoc-gen-go-errorx/gerr") // "github.com/wangzhe1991/protoc-gen-go-errorx/errors"
...
func genErrorsReason(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, enum *protogen.Enum) bool {
	...
	defaultHttpCode, startBizCode, defaultMessage := 0, 100001, ""
	if s, ok := settingsI.(*gerr.Settings); ok && s != nil {
		defaultHttpCode, startBizCode, defaultMessage = int(s.DefaultHttpCode), int(s.StartBizCode), s.DefaultMessage
	}
	...
	for _, v := range enum.Values {
		httpCode, curErrorNo, message := defaultHttpCode, 0, defaultMessage
